...
* **Downloadable OKF bundle** — optional `.zip` archive of the export tree with bundle-absolute internal links, kept fresh via bulk-generation rebuilds and a debounced WP-Cron schedule
