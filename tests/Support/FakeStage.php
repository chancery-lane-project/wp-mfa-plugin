...
final class FakeStage implements Stage {
     ...
     * @param \Throwable|null            $process_error      Thrown by process_batch() when set.
     */
    public function __construct(
        ...
        private ?\Throwable $process_error = null,
    ) {}
    ...
    public function process_batch( int $cursor, int $limit ): array {
        ...
        if ( null !== $this->process_error ) {
            throw $this->process_error;
        }
